...
if (envError) {
  console.error('❌ Fastify App environment variables are invalid. Errors:', z.prettifyError(envError));
  process.exit(1);
}
...
export const env = {
  ...parsedEnv,
  SERVER_URL: parsedEnv.FASTIFY_URL,
  SERVER_PORT: parsedEnv.FASTIFY_PORT,
